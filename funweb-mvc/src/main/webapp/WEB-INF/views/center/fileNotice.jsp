...
<body>
	...
	<div id="wrapper">
		<div id="page" class="container">
			...
			<section>
				<article>
					<h1 style="padding-left: 15px !important;">파일 게시판 [전체글갯수: ${ pageDto.totalCount} ]</h1>
					...
					<div id="table_search" class="col-md-5 col-md-offset-1">
						...
						<c:if test="${ not empty id }"><%-- ${ not empty sessionScope.id } --%>
							<input type="button" value="글쓰기" class="button"onclick="location.href='fileWriteForm.do?pageNum=${ pageNum }'">
						</c:if>
					</div>
